...
Architecture:
    Input  → LSTM (num_layers, hidden_size, dropout) → last hidden state
           → Dropout → Linear(hidden_size → pred_len) → Output
"""
...
class LSTMModel(nn.Module):
    """
    Stacked LSTM followed by a fully-connected output head.
